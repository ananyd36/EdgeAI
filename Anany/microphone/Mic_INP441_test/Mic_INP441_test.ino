...
const int i2s_bck_pin = 22;    // Serial Clock (BCLK)  - connect to SCK on INMP441
const int i2s_ws_pin = 25;     // Word Select (LRCLK) - connect to WS on INMP441
const int i2s_data_pin = 21;   // Serial Data (DOUT)   - connect to SD on INMP441
